...
#去  https://github.com/rekiksab/Yelp/tree/master/yelp_challenge/yelp_phoenix_academic_dataset  下载完整的   yelp_academic_dataset_review.json  大概两百多M。  这里的只是截取的很小的示例跑通程序

# Data loading params
tf.flags.DEFINE_string("yelp_json_path", 'yelp_academic_dataset_review.json', "data directory")
...
with tf.Session() as sess:
    ...
    for epoch in range(FLAGS.num_epochs):
        ...
        for i in range(0, 1984, FLAGS.batch_size):
